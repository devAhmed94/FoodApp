...
public class SearchModel implements Parcelable {
    ...
    public SearchModel(String image_url, double social_rank, String _id,
                       String publisher, String source_url, String recipe_id, String publisher_url, String title) {
